...
from miner.intelligence.core.molnextr import MolScribe
from miner.intelligence.core.rxnim import RxnScribe, MolDetect
...
class ChemIEToolkit:
    ...
    def init_pdfparser(self, ckpt_path=None):
        ...
        try:
            ...
            raise ImportError("layoutparser is required for PDF parsing. Please install it with 'pip install layoutparser'.")
